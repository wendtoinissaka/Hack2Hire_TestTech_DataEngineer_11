...
# scheduler.add_job(func=fetch_and_store_weather, trigger="interval", hours=24)  # Exécuter tous les 24 heures
scheduler.add_job(func=fetch_and_store_weather, trigger="interval", minutes=1)  # Exécuter tous les 24 heures
scheduler.start()
